# RAG System with DeepSeek-R1 Web UI

You will create an enhanced RAG application that combines the indexing and retrieval functionalities into a user-friendly Gradio interface. This implementation includes advanced features like document management, query visualization, and response exporting capabilities.
...
1. **Modern UI with Tabbed Interface**
   - Separate tabs for document indexing, querying, and settings
   - Clean, intuitive design using Gradio's Soft theme
...
3. **Robust Index Management**
   - Create, view, and delete indexes
   - Detailed index information display
   - Safe filename handling and validation

4. **Advanced Query Features**
   - Adjustable retrieval parameters
   - Display of retrieved document chunks
   - Optional display of full context sent to the model
   - Copy to clipboard and export functionality

5. **Persistent Configuration**
   - Settings saved between sessions
   - Secure API key storage
   - Customizable model and API parameters
...
This implementation combines the core RAG functionality from the original code with a powerful yet user-friendly interface that makes it easy to manage documents, create indexes, and generate high-quality responses using the DeepSeek-R1 LLM.
